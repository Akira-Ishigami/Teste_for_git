...
def alternar_sublinhado(label):
    ...
    if "overstrike" in fonte_atual:
        # Remover o estilo de overstrike
        nova_fonte = fonte_atual.replace(" overstrike", "")
    else:
        # Adicionar o estilo de overstrike
