...
# segunda linha
b_4 = Button(frame_quadros, command=lambda: entrar_valor('7'), text="7", width=5, height=2, bg=co3, fg=co1, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_4.place(x=0, y=52)

b_5 = Button(frame_quadros, command=lambda: entrar_valor('8'), text="8", width=5, height=2, bg=co3, fg=co1, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_5.place(x=59, y=52)

b_6 = Button(frame_quadros, command=lambda: entrar_valor('9'), text="9", width=5, height=2, bg=co3, fg=co1, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
# terceira coluna
b_8 = Button(frame_quadros, command=lambda: entrar_valor('4'), text="4", width=5, height=2, bg=co3, fg=co1, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_8.place(x=0, y=104)

b_9 = Button(frame_quadros, command=lambda: entrar_valor('5'), text="5", width=5, height=2, bg=co3, fg=co1, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_9.place(x=59, y=104)

b_10 = Button(frame_quadros, command=lambda: entrar_valor('6'), text="6", width=5, height=2, bg=co3, fg=co1, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
# quarta coluna
b_12 = Button(frame_quadros, command=lambda: entrar_valor('1'), text="1", width=5, height=2, bg=co3, fg=co1, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_12.place(x=0, y=156)

b_13 = Button(frame_quadros, command=lambda: entrar_valor('2'), text="2", width=5, height=2, bg=co3, fg=co1, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_13.place(x=59, y=156)

b_14 = Button(frame_quadros, command=lambda: entrar_valor('3'), text="3", width=5, height=2, bg=co3, fg=co1, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
# quinta coluna
b_16 = Button(frame_quadros, command=lambda: entrar_valor('0'), text="0", width=11, height=2, bg=co3, fg=co1, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_16.place(x=0, y=208)

b_17 = Button(frame_quadros, command=lambda: entrar_valor('.'), text=".", width=5, height=2, bg=co3, fg=co1, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
